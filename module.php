<?php
	...
	$home = getcwd();
	if (!file_exists($home.'/.modules'))
	{
		echo color("Please cd to into folder containing file .modules", RED);
		exit;
	}
	...
	{
		echo color("Error opening .modules file", RED);
	}
